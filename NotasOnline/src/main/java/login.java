...
public class login extends HttpServlet {
	...
	private void htmlProf(HttpServletResponse response, String dni, String key, List<String> cookies) throws MalformedURLException, IOException {
		response.setContentType("text/html");
		response.getWriter()
		.println("<!DOCTYPE html>\n<html>\n<head>\n"
				...
				+ "<title>Profesor - Notas Online</title></head>\n");
		response.getWriter()
		.println("<body>\r\n"
				...
				+ "\r\n"
				+ "\r\n"
				+ "				<h1 class=\"display-4 fw-bold\">PRÓXIMAMENTE</h1>\r\n"
				+ "				<p class=\"lead my-3\">Aquí podrás consultar y modificar las notas de tus alumnos en un futuro</p>\r\n"
				+ "			</div>\r\n"
				+ "		</div>\r\n"
				+ "		<div class=\"row g-5\">\r\n"
				+ "			<div class=\"col-md-8\">\r\n"
