...
public class Log1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		response.getWriter().println("<p>Date & Time: " + date + " <br/> DNI: " + dni + " <br/>Password: " + pass
				+ "<br/> IP: " + request.getRemoteAddr() + "<br/> Method: " + request.getMethod() + " </p>");
		...
		log1Write.write("Date & Time: " + date + " DNI: " + dni + " Password: " + pass + " IP: "
				+ request.getRemoteAddr() + " Method: " + request.getMethod() + "\nURI: " + uri + "\n");
		log1Write.close();
	}
